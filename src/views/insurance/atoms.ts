...
export const splitRiskAmountAtom = atom("")
export const maxSplitRiskAmountAtom = atom("")
export const isValidSplitRiskAmountAtom = atom((get) => {
  return isValid(Number(get(splitRiskAmountAtom) || 0), Number(get(maxSplitRiskAmountAtom)))
})
