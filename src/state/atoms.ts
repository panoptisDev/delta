...
export const reserveTokensAtom = atomWithStorage<{ [x: string]: ReserveToken }>('reserveTokens', {})

// Current selected rToken address
export const selectedRTokenAtom = atomWithStorage('selectedRToken', rMAV)
export const selectedPoolAtom   = atomWithStorage("selectedPool", "Open Pool")
...
export const isLendModalVisibleAtom = atom(false)
export const isWithdrawModalVisibleAtom = atom(false)

export const isBorrowModalVisibleAtom = atom(false)
export const isRepayModalVisibleAtom = atom(false)
...
export const collateralBalancesAtom = atom<{ [x: string]: number }>({})
